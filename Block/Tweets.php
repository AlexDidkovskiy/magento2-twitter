<?php
namespace AlexDidkovskiy\Twitter\Block;

class Tweets extends \Magento\Framework\View\Element\Template
{
    /**
     * @var \AlexDidkovskiy\Twitter\Helper\Data
     */
    protected $_helper;
     ...
     * @param array                                            $data
     * @param \AlexDidkovskiy\Twitter\Helper\Data                  $helper
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        array $data = [],
        \AlexDidkovskiy\Twitter\Helper\Data $helper
    ) {
        $this->_helper = $helper;
